...
function gptweaks_footer_bar( $wp_customize ) {
    ...
    $wp_customize->add_section( 'gptweaks_footer_bar_section', array(
    ...
    $wp_customize->add_setting( 'gptweaks_toggle_display_footer_bar', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field',
	) );

	// Checkbox for toggle Footer Bar
	$wp_customize->add_control( 'gptweaks_toggle_display_footer_bar', array(
	'type' => 'checkbox',
    ...
    $wp_customize->add_setting( 'gptweaks_replacement_text_footer_bar', array(
		'default' => '',
		'sanitize_callback' => 'wp_kses_post',
	) );

	// Checkbox control for Replacement Footer Bar Text Setting
	$wp_customize->add_control( 'gptweaks_replacement_text_footer_bar', array(
	'type' => 'textarea',
	'section' => 'gptweaks_footer_bar_section',
  ...
  'input_attrs' => array(
	...
	// Footer Bar Color
    $wp_customize->add_setting( 'gptweaks_footer_bar_color' , array(
        'default'     => '',
		'sanitize_callback' => 'sanitize_hex_color',
    ) );

    // Add color picker control for Footer Bar
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'gptweaks_footer_bar_color', array(
 ...
 // Footer Bar Text Color
  $wp_customize->add_setting( 'gptweaks_footer_bar_text_color' , array(
      'default'     => '',
  'sanitize_callback' => 'sanitize_hex_color',
  ) );

    // Add color picker control for Footer Bar Text
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'gptweaks_footer_bar_text_color', array(
 ...
 // Footer Bar Link Text Color
  $wp_customize->add_setting( 'gptweaks_footer_bar_link_color' , array(
      'default'     => '',
  'sanitize_callback' => 'sanitize_hex_color',
  ) );

    // Add color picker control for Footer Bar Link Text Color
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'gptweaks_footer_bar_link_color', array(
 ...
 // Footer Bar Visited Link Text Color
  $wp_customize->add_setting( 'gptweaks_footer_bar_visited_link_color' , array(
      'default'     => '',
  'sanitize_callback' => 'sanitize_hex_color',
  ) );

    // Add color picker control for Footer Bar Visited Link Text
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'gptweaks_footer_bar_visited_link_color', array(
...
// Action on selected settings
  ...
  $gptweaks_site_footer_bar_color = get_theme_mod( 'gptweaks_footer_bar_color' );
  	...
  	?>
  		<style type="text/css">
  			.site-info {
  				background-color: <?php echo $gptweaks_site_footer_bar_color; ?>;
  			}
  		</style>
  ...
  $gptweaks_site_footer_bar_text_color = get_theme_mod( 'gptweaks_footer_bar_text_color' );
    	...
    	?>
    		<style type="text/css">
    			.site-info{
    				color: <?php echo $gptweaks_site_footer_bar_text_color; ?>;
    			}
    		</style>
  ...
  $gptweaks_site_footer_bar_link_color = get_theme_mod( 'gptweaks_footer_bar_link_color' );
      ...
      ?>
      	<style type="text/css">
        	.site-info a{
        		color: <?php echo $gptweaks_site_footer_bar_link_color; ?>;
        	}
      	</style>
  ...
  $gptweaks_site_footer_bar_visited_link_color = get_theme_mod( 'gptweaks_footer_bar_visited_link_color' );
      ...
      ?>
        <style type="text/css">
        	.site-info a:visited{
            	color: <?php echo $gptweaks_site_footer_bar_visited_link_color; ?>;
          }
      	</style>
