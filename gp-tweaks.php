 ...
 * Description: Tweaks for GeneratePress. Typography - menu sizes, bolding, transforms. More menu colors, disable footer bar, add header and title color.
 * Version:     1.0.3
 * Author:      John Chapman
...
if ( preg_match( '/generatepress/i', $theme ) ) {
	...
	require_once( 'gp-typography.php' );
