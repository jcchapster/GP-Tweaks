...
function gptweaks_typography_settings( $wp_customize ) {
	...
	$wp_customize->add_section(
		'gptweaks_typography_settings_section',
		array(
	...
	$wp_customize->add_setting(
		'gptweaks_menu_fontsize_setting',
		array(
			'default'           => '',
	...
	$wp_customize->add_setting(
		'gptweaks_menu_normal_or_bold_setting',
		array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
		)
	...
	// Dropdown selector for Bold or Normal Control
	$wp_customize->add_control(
		'gptweaks_menu_normal_or_bold_setting',
		array(
	...
	// Menu Text Transform
	$wp_customize->add_setting(
		'gptweaks_menu_text_transform_setting',
		array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
		)
...
function gptweaks_typography_settings_apply() {
	...
	<style type="text/css">
		.main-navigation a, .main-navigation .main-nav ul ul li a {
			font-size: <?php echo esc_html( $menu_fontsize_selected ); ?>;
		}
	</style>
	...
	<style type="text/css">
		.main-navigation a, .main-navigation .main-nav ul ul li a {
			font-weight: <?php echo esc_html( $menu_fontweight_selected ); ?>;
		}
	</style>
	...
	<style type="text/css">
		.main-navigation a, .main-navigation .main-nav ul ul li a {
			text-transform: <?php echo esc_html( $menu_text_transform_selected ); ?>;
		}
	</style>
