...
function gptweaks_back_to_top( $wp_customize ) {
   ...
   // Section for customizer controls
    $wp_customize->add_section( 'gptweaks_back_to_top_section' , array(
    ...
    $wp_customize->add_setting( 'gptweaks_back_to_top_color' , array(
        'default'     => '',
		'sanitize_callback' => 'sanitize_hex_color',
    ) );

    // Back To Top Color Control
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'gptweaks_back_to_top_color', array(
    ...
    $wp_customize->add_setting( 'gptweaks_back_to_top_hover_color' , array(
        'default'     => '',
		'sanitize_callback' => 'sanitize_hex_color',
    ) );

    // Back To Top Hover Color Control
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'gptweaks_back_to_top_hover_color', array(
    ...
    $wp_customize->add_setting( 'gptweaks_back_to_top_opacity', array(
    'default'     => '',
		'sanitize_callback' => 'sanitize_text_field',
    ) );

    // Back To Top Opacity  Control
	$wp_customize->add_control( 'gptweaks_back_to_top_opacity', array(
	...
	?>
		<style type="text/css">
			 .generate-back-to-top, .generate-back-to-top:focus {
  				background-color: <?php echo $gptweaks_btt_color; ?>;
          opacity: <?php echo $back_to_top_opacity; ?>!important;
			}
		</style>
	<?php
	...
	?>
		<style type="text/css">
			 .generate-back-to-top:hover {
  				background-color: <?php echo $gptweaks_btt_hover_color; ?>;
          opacity: <?php echo $back_to_top_opacity; ?>!important;
			}
		</style>
	<?php
